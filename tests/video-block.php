...
$assert(str_contains($block_source, 'render_peertube_iframe') && str_contains($block_source, 'awvp-provider-embed--peertube'), 'AWVP block lost the safe managed-PeerTube iframe renderer.');
