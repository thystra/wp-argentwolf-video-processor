...
$assert(str_contains($admin, 'Stale since %s UTC; refresh must succeed before these choices can be treated as current.'), 'Stale publication-choice state is not surfaced to administrators.');
