...
$refreshed_authority=$authority;$refreshed_authority['verified_at']=2200;$a(E::remote_identity_matches_authority($done,$refreshed_authority),'Completed remote identity should tolerate mutable verification time.');$a(E::proof_sha256($done)!==E::authority_sha256($refreshed_authority),'Full active cleanup proof unexpectedly ignored mutable authority fields.');$changed_authority=$refreshed_authority;$changed_authority['remote_uuid']='bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb';$a(!E::remote_identity_matches_authority($done,$changed_authority),'Completed remote identity must fail closed on UUID drift.');
