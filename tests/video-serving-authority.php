...
$short=$asset;$short['embed_url']='https://video.example.org/videos/embed/5wwQY8261uRv7aPsVWhEiY';$shortRecord=Authority::create(77,$lifecycle,$execution,$short,1040);$a([]!==$shortRecord&&$short['embed_url']===$shortRecord['embed_url'],'Valid provider short embed ID did not authorize serving.');$a($shortRecord===Authority::sanitize($shortRecord),'Short-ID serving authority did not round-trip.');
$bad=$asset;$bad['embed_url']='https://video.example.org/videos/embed/5wwQY8261uRv7aPsVWhEiY?autoplay=1';$a([]===Authority::create(77,$lifecycle,$execution,$bad,1040),'Embed query string authorized serving.');
$bad=$asset;$bad['embed_url']='https://video.example.org/videos/embed/../watch';$a([]===Authority::create(77,$lifecycle,$execution,$bad,1040),'Malformed/traversal embed path authorized serving.');
