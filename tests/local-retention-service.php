...
$GLOBALS['r469_meta']=array();$GLOBALS['r469_outputs']=array(20=>array('mp4'=>array('path'=>'x')));$GLOBALS['r469_storage_removed']=0;$GLOBALS['r469_source_deleted']=0;$GLOBALS['r469_source_matches']=true;$GLOBALS['r469_source_absent']=false;
...
function get_post(int $id):mixed{if(100===$id)return(object)array('ID'=>100,'post_type'=>Video_Post_Type::POST_TYPE,'post_status'=>'publish');if(20===$id)return(object)array('ID'=>20,'post_type'=>'attachment','post_status'=>'inherit');return null;}
...
function get_posts(array $args=array()):array{unset($args);return array(100);}
...
final class WordPress_Source_File{
 public static function capture(int $id):array{return 20===$id?array('relative_path'=>'2026/09/video.mp4','bytes'=>10,'device'=>1,'inode'=>2,'mtime'=>3):array();}
