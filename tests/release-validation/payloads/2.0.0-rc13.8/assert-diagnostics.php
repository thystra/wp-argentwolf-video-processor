...
$capture_row = awvp_rc_worker_row($capture_run);
...
$stale_row = awvp_rc_worker_row($stale_run);
...
$repo->clear_retained();
awvp_release_assert(0 === awvp_rc_count_worker_bucket('success'), 'Could not clear success history.');
awvp_release_assert(0 === awvp_rc_count_worker_bucket('error'), 'Could not clear error history.');
...
awvp_release_assert(
    2 === awvp_rc_count_worker_bucket('success'),
    'Successful worker retention limit was not enforced.'
);
awvp_release_assert(
    3 === awvp_rc_count_worker_bucket('error'),
...
$repo->clear_retained();
awvp_release_assert(0 === awvp_rc_count_worker_bucket('success'), 'Final success-history cleanup failed.');
awvp_release_assert(0 === awvp_rc_count_worker_bucket('error'), 'Final error-history cleanup failed.');
