# AWVP release-validation payload: 2.0.0-rc13.11
...
CANDIDATE_ARTIFACT="${AWVP_RC_CANDIDATE_ARTIFACT:-argentwolf-video-processor-2.0.0-rc13.11.zip}"
CANDIDATE_SHA256="${AWVP_RC_CANDIDATE_SHA256:-}"
CANDIDATE_VERSION="2.0.0-rc13.11"
