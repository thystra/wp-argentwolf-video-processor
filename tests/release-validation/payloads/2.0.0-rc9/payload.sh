# AWVP release-validation payload: 2.0.0-rc9
...
CANDIDATE_ARTIFACT="${AWVP_RC_CANDIDATE_ARTIFACT:-argentwolf-video-processor-2.0.0-rc9.zip}"
CANDIDATE_SHA256="${AWVP_RC_CANDIDATE_SHA256:-}"
CANDIDATE_VERSION="2.0.0-rc9"
CANDIDATE_STABLE_TAG="1.0.0"
CANDIDATE_DB_VERSION="2"
CANDIDATE_MODEL_DB_VERSION="1"
