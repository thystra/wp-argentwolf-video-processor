...
foreach ($required_classes as $class) {
    awvp_release_assert(class_exists($class) || interface_exists($class), "Required RC10 live-fix runtime class/interface is not packaged: {$class}");
}
...
awvp_release_assert(
    ...
    'RC10 processing viability state is not available.'
);
...
awvp_release_assert(
    ...
    'Unconfigured remote backend serving priority did not use the safe RC10 default.'
);
...
echo "AWVP_RC10_LIVEFIX_CONTRACT_PASS\n";
