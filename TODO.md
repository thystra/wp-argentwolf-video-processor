...
- [ ] Freeze and qualify the exact RC13.2 package after source CI, including a dedicated 1.0 -> RC13.2 release-validation payload and the remaining RC13.1 Test-7 Private/failover evidence before replacing RC13.1 on production.
