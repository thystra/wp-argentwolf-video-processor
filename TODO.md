...
- [ ] Complete the RC13.2 source window before stable promotion: Videos & Routing/migration UX, Never/per-video retention plus keep-HLS/source-prune mode, explicit Check now/verified remote restore and retained-source local-delivery rebuild, Publication History/operator wording cleanup, and reviewed pre-publish PeerTube visibility for scheduled Send-now publishing. Capture the RC13.1 Test-7 Private/failover observation before replacing RC13.1 on production.
