...
final class PeerTube_Api_Error
{
    ...
    private static function reviewed_local_code(string $value): string
    {
        $allowed = array(
            ...
            'publication_catalog_token_invalid',
            'publication_categories_content_type_invalid',
            'publication_categories_json_invalid',
            'publication_categories_shape_invalid',
            'publication_categories_status_invalid',
            'publication_config_content_type_invalid',
            'publication_config_json_invalid',
            'publication_config_shape_invalid',
            'publication_config_status_invalid',
            'publication_languages_content_type_invalid',
            'publication_languages_json_invalid',
            'publication_languages_shape_invalid',
            'publication_languages_status_invalid',
            'publication_licences_content_type_invalid',
            'publication_licences_json_invalid',
            'publication_licences_shape_invalid',
            'publication_licences_status_invalid',
            'publication_privacies_content_type_invalid',
            'publication_privacies_json_invalid',
            'publication_privacies_shape_invalid',
            'publication_privacies_status_invalid',
            'publication_version_invalid',
            'response_content_encoding_unsupported',
            'remote_video_content_type_invalid',
            'remote_video_input_invalid',
            'remote_video_json_invalid',
            'remote_video_shape_invalid',
            'remote_video_status_invalid',
            'response_too_large',
            ...
            'upload_init_location_malformed',
            'upload_init_location_missing',
            'upload_init_location_origin_mismatch',
            'upload_init_location_path_invalid',
            'upload_init_location_query_invalid',
